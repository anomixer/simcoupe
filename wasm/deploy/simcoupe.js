...
// include: C:\Users\USER\AppData\Local\Temp\tmpdilqd3g3.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'simcoupe.data';
      var REMOTE_PACKAGE_BASE = 'simcoupe.data';
...
Module['FS_createPath']("/", "Resource", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_simcoupe.data');
      }
      Module['addRunDependency']('datafile_simcoupe.data');
    ...
    loadPackage({"files": [{"filename": "/Resource/SimCoupe.bmp", "start": 0, "end": 4150}, {"filename": "/Resource/atom.rom", "start": 4150, "end": 36918}, {"filename": "/Resource/atomlite.rom", "start": 36918, "end": 69686}, {"filename": "/Resource/samcoupe.rom", "start": 69686, "end": 102454}, {"filename": "/Resource/samdos2.map", "start": 102454, "end": 109520}, {"filename": "/Resource/samdos2.sbt", "start": 109520, "end": 119520}, {"filename": "/Resource/samports.map", "start": 119520, "end": 120079}, {"filename": "/Resource/samrom.map", "start": 120079, "end": 157093}, {"filename": "/Resource/sp0256-al2.bin", "start": 157093, "end": 159141}], "remote_package_size": 159141});

  })();

// end include: C:\Users\USER\AppData\Local\Temp\tmpdilqd3g3.js
// include: C:\Users\USER\AppData\Local\Temp\tmpvkjtmgzn.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\USER\AppData\Local\Temp\tmpvkjtmgzn.js
// include: C:\Users\USER\AppData\Local\Temp\tmp5s4p55is.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\USER\AppData\Local\Temp\tmp5s4p55is.js
...
function findWasmBinary() {
  return locateFile('simcoupe.wasm');
}
...
var ASM_CONSTS = {
  5579020: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 5579235: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 5579382: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 5579616: ($0) => { if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { if ((typeof navigator.userActivation) === 'undefined') { autoResumeAudioContext(SDL2.audioContext); } } } return SDL2.audioContext === undefined ? -1 : 0; },  
 5580168: () => { var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate; },  
 5580236: ($0, $1, $2, $3) => { var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearInterval(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; SDL2.capture.silenceBuffer = undefined } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vp', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vp', $2, [$3]); }; SDL2.capture.silenceTimer = setInterval(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); } },  
 5581929: ($0, $1, $2, $3) => { var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } if (SDL2.audio.silenceTimer !== undefined) { clearInterval(SDL2.audio.silenceTimer); SDL2.audio.silenceTimer = undefined; SDL2.audio.silenceBuffer = undefined; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vp', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']); if (SDL2.audioContext.state === 'suspended') { SDL2.audio.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.audio.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { if ((typeof navigator.userActivation) !== 'undefined') { if (navigator.userActivation.hasBeenActive) { SDL2.audioContext.resume(); } } SDL2.audio.currentOutputBuffer = SDL2.audio.silenceBuffer; dynCall('vp', $2, [$3]); SDL2.audio.currentOutputBuffer = undefined; }; SDL2.audio.silenceTimer = setInterval(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); } },  
 5583104: ($0, $1) => { var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } } },  
 5583709: ($0, $1) => { var SDL2 = Module['SDL2']; var buf = $0 >>> 2; var numChannels = SDL2.audio.currentOutputBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.audio.currentOutputBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio output buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[buf + (j*numChannels + c)]; } } },  
 5584198: ($0) => { var SDL2 = Module['SDL2']; if ($0) { if (SDL2.capture.silenceTimer !== undefined) { clearInterval(SDL2.capture.silenceTimer); } if (SDL2.capture.stream !== undefined) { var tracks = SDL2.capture.stream.getAudioTracks(); for (var i = 0; i < tracks.length; i++) { SDL2.capture.stream.removeTrack(tracks[i]); } } if (SDL2.capture.scriptProcessorNode !== undefined) { SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) {}; SDL2.capture.scriptProcessorNode.disconnect(); } if (SDL2.capture.mediaStreamNode !== undefined) { SDL2.capture.mediaStreamNode.disconnect(); } SDL2.capture = undefined; } else { if (SDL2.audio.scriptProcessorNode != undefined) { SDL2.audio.scriptProcessorNode.disconnect(); } if (SDL2.audio.silenceTimer !== undefined) { clearInterval(SDL2.audio.silenceTimer); } SDL2.audio = undefined; } if ((SDL2.audioContext !== undefined) && (SDL2.audio === undefined) && (SDL2.capture === undefined)) { SDL2.audioContext.close(); SDL2.audioContext = undefined; } },  
 5585204: ($0, $1, $2) => { var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Browser.createContext(Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels / 4; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); SDL2.data32Data = data; } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); },  
 5586670: ($0, $1, $2, $3, $4) => { var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels / 4; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf; },  
 5587658: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 5587741: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 5587810: () => { return window.innerWidth; },  
 5587840: () => { return window.innerHeight; }
};

// Imports from the Wasm binary.
var _free = makeInvalidEarlyAccess('_free');
var _EMS_InsertDisk = Module['_EMS_InsertDisk'] = makeInvalidEarlyAccess('_EMS_InsertDisk');
var _EMS_InsertTape = Module['_EMS_InsertTape'] = makeInvalidEarlyAccess('_EMS_InsertTape');
var _EMS_IsDiskModified = Module['_EMS_IsDiskModified'] = makeInvalidEarlyAccess('_EMS_IsDiskModified');
var _EMS_ClearDiskModified = Module['_EMS_ClearDiskModified'] = makeInvalidEarlyAccess('_EMS_ClearDiskModified');
var _EMS_FlushDisk = Module['_EMS_FlushDisk'] = makeInvalidEarlyAccess('_EMS_FlushDisk');
var _EMS_Reset = Module['_EMS_Reset'] = makeInvalidEarlyAccess('_EMS_Reset');
var _EMS_Boot = Module['_EMS_Boot'] = makeInvalidEarlyAccess('_EMS_Boot');
var _EMS_EjectDisk = Module['_EMS_EjectDisk'] = makeInvalidEarlyAccess('_EMS_EjectDisk');
var _EMS_EjectTape = Module['_EMS_EjectTape'] = makeInvalidEarlyAccess('_EMS_EjectTape');
var _EMS_DoAction = Module['_EMS_DoAction'] = makeInvalidEarlyAccess('_EMS_DoAction');
var _EMS_GetLastWavPath = Module['_EMS_GetLastWavPath'] = makeInvalidEarlyAccess('_EMS_GetLastWavPath');
var _EMS_GetLastGifPath = Module['_EMS_GetLastGifPath'] = makeInvalidEarlyAccess('_EMS_GetLastGifPath');
var _EMS_GetLastPngPath = Module['_EMS_GetLastPngPath'] = makeInvalidEarlyAccess('_EMS_GetLastPngPath');
var _EMS_GetFPS = Module['_EMS_GetFPS'] = makeInvalidEarlyAccess('_EMS_GetFPS');
var _EMS_GetLastAviPath = Module['_EMS_GetLastAviPath'] = makeInvalidEarlyAccess('_EMS_GetLastAviPath');
var _EMS_GetOption = Module['_EMS_GetOption'] = makeInvalidEarlyAccess('_EMS_GetOption');
var _EMS_SetOption = Module['_EMS_SetOption'] = makeInvalidEarlyAccess('_EMS_SetOption');
var _main = Module['_main'] = makeInvalidEarlyAccess('_main');
var _EMS_SetAudioEnabled = Module['_EMS_SetAudioEnabled'] = makeInvalidEarlyAccess('_EMS_SetAudioEnabled');
var _EMS_StartAudio = Module['_EMS_StartAudio'] = makeInvalidEarlyAccess('_EMS_StartAudio');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['EMS_InsertDisk'] != 'undefined', 'missing Wasm export: EMS_InsertDisk');
  assert(typeof wasmExports['EMS_InsertTape'] != 'undefined', 'missing Wasm export: EMS_InsertTape');
  assert(typeof wasmExports['EMS_IsDiskModified'] != 'undefined', 'missing Wasm export: EMS_IsDiskModified');
  assert(typeof wasmExports['EMS_ClearDiskModified'] != 'undefined', 'missing Wasm export: EMS_ClearDiskModified');
  assert(typeof wasmExports['EMS_FlushDisk'] != 'undefined', 'missing Wasm export: EMS_FlushDisk');
  assert(typeof wasmExports['EMS_Reset'] != 'undefined', 'missing Wasm export: EMS_Reset');
  assert(typeof wasmExports['EMS_Boot'] != 'undefined', 'missing Wasm export: EMS_Boot');
  assert(typeof wasmExports['EMS_EjectDisk'] != 'undefined', 'missing Wasm export: EMS_EjectDisk');
  assert(typeof wasmExports['EMS_EjectTape'] != 'undefined', 'missing Wasm export: EMS_EjectTape');
  assert(typeof wasmExports['EMS_DoAction'] != 'undefined', 'missing Wasm export: EMS_DoAction');
  assert(typeof wasmExports['EMS_GetLastWavPath'] != 'undefined', 'missing Wasm export: EMS_GetLastWavPath');
  assert(typeof wasmExports['EMS_GetLastGifPath'] != 'undefined', 'missing Wasm export: EMS_GetLastGifPath');
  assert(typeof wasmExports['EMS_GetLastPngPath'] != 'undefined', 'missing Wasm export: EMS_GetLastPngPath');
  assert(typeof wasmExports['EMS_GetFPS'] != 'undefined', 'missing Wasm export: EMS_GetFPS');
  assert(typeof wasmExports['EMS_GetLastAviPath'] != 'undefined', 'missing Wasm export: EMS_GetLastAviPath');
  assert(typeof wasmExports['EMS_GetOption'] != 'undefined', 'missing Wasm export: EMS_GetOption');
  assert(typeof wasmExports['EMS_SetOption'] != 'undefined', 'missing Wasm export: EMS_SetOption');
  assert(typeof wasmExports['__main_argc_argv'] != 'undefined', 'missing Wasm export: __main_argc_argv');
  assert(typeof wasmExports['EMS_SetAudioEnabled'] != 'undefined', 'missing Wasm export: EMS_SetAudioEnabled');
  assert(typeof wasmExports['EMS_StartAudio'] != 'undefined', 'missing Wasm export: EMS_StartAudio');
  ...
  _EMS_InsertDisk = Module['_EMS_InsertDisk'] = createExportWrapper('EMS_InsertDisk', 2);
  _EMS_InsertTape = Module['_EMS_InsertTape'] = createExportWrapper('EMS_InsertTape', 1);
  _EMS_IsDiskModified = Module['_EMS_IsDiskModified'] = createExportWrapper('EMS_IsDiskModified', 1);
  _EMS_ClearDiskModified = Module['_EMS_ClearDiskModified'] = createExportWrapper('EMS_ClearDiskModified', 1);
  _EMS_FlushDisk = Module['_EMS_FlushDisk'] = createExportWrapper('EMS_FlushDisk', 1);
  _EMS_Reset = Module['_EMS_Reset'] = createExportWrapper('EMS_Reset', 0);
  _EMS_Boot = Module['_EMS_Boot'] = createExportWrapper('EMS_Boot', 1);
  _EMS_EjectDisk = Module['_EMS_EjectDisk'] = createExportWrapper('EMS_EjectDisk', 1);
  _EMS_EjectTape = Module['_EMS_EjectTape'] = createExportWrapper('EMS_EjectTape', 0);
  _EMS_DoAction = Module['_EMS_DoAction'] = createExportWrapper('EMS_DoAction', 1);
  _EMS_GetLastWavPath = Module['_EMS_GetLastWavPath'] = createExportWrapper('EMS_GetLastWavPath', 0);
  _EMS_GetLastGifPath = Module['_EMS_GetLastGifPath'] = createExportWrapper('EMS_GetLastGifPath', 0);
  _EMS_GetLastPngPath = Module['_EMS_GetLastPngPath'] = createExportWrapper('EMS_GetLastPngPath', 0);
  _EMS_GetFPS = Module['_EMS_GetFPS'] = createExportWrapper('EMS_GetFPS', 0);
  _EMS_GetLastAviPath = Module['_EMS_GetLastAviPath'] = createExportWrapper('EMS_GetLastAviPath', 0);
  _EMS_GetOption = Module['_EMS_GetOption'] = createExportWrapper('EMS_GetOption', 1);
  _EMS_SetOption = Module['_EMS_SetOption'] = createExportWrapper('EMS_SetOption', 2);
  _main = Module['_main'] = createExportWrapper('__main_argc_argv', 2);
  _EMS_SetAudioEnabled = Module['_EMS_SetAudioEnabled'] = createExportWrapper('EMS_SetAudioEnabled', 1);
  _EMS_StartAudio = Module['_EMS_StartAudio'] = createExportWrapper('EMS_StartAudio', 0);
